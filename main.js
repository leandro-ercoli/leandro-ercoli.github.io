...
/*!*****************************************************************!*\
  !*** C:/Users/Leandro/node_modules/moment/locale sync ^\.\/.*$ ***!
  \*****************************************************************/
...
/* harmony import */ var _predicciones_predicciones_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./predicciones/predicciones.component */ "./src/app/predicciones/predicciones.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _predicciones_predicciones_component__WEBPACK_IMPORTED_MODULE_8__["PrediccionesComponent"]
            ],
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot([
                    ...
                    {
                        path: 'predicciones',
                        component: _predicciones_predicciones_component__WEBPACK_IMPORTED_MODULE_8__["PrediccionesComponent"]
                    }
                ])
            ],
...
module.exports = ".card-realtime .card-title{\r\n    padding-bottom:1.5rem;\r\n}\r\n.card-realtime .card-content{\r\n    padding-top:0px;\r\n}\r\ntbody {\r\n    display:block;\r\n    height:250px;\r\n    overflow:auto;\r\n}\r\nthead, tbody tr {\r\n    display:table;\r\n    width:100%;\r\n    table-layout:fixed;\r\n}\r\nth {\r\n    font-weight:500;\r\n    padding-bottom:0px;\r\n    padding-top:0px;\r\n}\r\n.card-realtime .card-content-graph{\r\n    padding:0;\r\n}\r\n/* animaciones real-time stats*/\r\n.pulse {\r\n    -webkit-animation: blinker 1.5s cubic-bezier(.5, 0, 1, 1) infinite alternate;\r\n            animation: blinker 1.5s cubic-bezier(.5, 0, 1, 1) infinite alternate;  \r\n}\r\n@-webkit-keyframes blinker {\r\n    from { opacity: 1; }\r\n    to { opacity: 0.3; }\r\n}\r\n@keyframes blinker {\r\n    from { opacity: 1; }\r\n    to { opacity: 0.3; }\r\n}"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(dataService) {
        ...
        this.criptomonedas_activas = 0;
        this.mercados_activos = 0;
        this.dominacion_bitcoin = 0;
        this.market_cap_total = 0;
        this.vol24h_total = 0;
    }
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getRealTimeCryptoValues().subscribe(function (res) {
            _this.realTimeData = res.data;
            // Configuración de charts
            chart_js__WEBPACK_IMPORTED_MODULE_2__["defaults"].global.defaultFontFamily = "'Roboto', sans-serif";
            chart_js__WEBPACK_IMPORTED_MODULE_2__["defaults"].global.defaultFontColor = "#FFF";
            chart_js__WEBPACK_IMPORTED_MODULE_2__["defaults"].global.defaultFontStyle = 200;
            chart_js__WEBPACK_IMPORTED_MODULE_2__["defaults"].global.defaultFontSize = 14;
            ...
            var borderColors = [];
            for (var i = 0; i < 15; i++) {
                percent_change_1h.push(_this.realTimeData[i].quotes.USD.percent_change_1h);
                percent_change_24h.push(_this.realTimeData[i].quotes.USD.percent_change_24h);
                percent_change_7d.push(_this.realTimeData[i].quotes.USD.percent_change_7d);
                market_cap.push(_this.realTimeData[i].quotes.USD.market_cap);
                labels.push(_this.realTimeData[i].name);
                colors.push(_this.realTimeData[i].quotes.USD.percent_change_24h >= 0 ? 'rgba(0, 255, 0, 0.5)' : 'rgba(255, 0, 0, 0.5)');
                borderColors.push(_this.realTimeData[i].quotes.USD.percent_change_24h >= 0 ? 'green' : 'red');
            }
            //Chart Bitcoin
            var myChartBitcoin = new chart_js__WEBPACK_IMPORTED_MODULE_2__(document.getElementById('chart-change'), {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [{
            ...
            //Chart radar
            new chart_js__WEBPACK_IMPORTED_MODULE_2__(document.getElementById("chart-radar"), {
                type: 'radar',
                data: {
                    labels: labels,
                    datasets: [
                        ...
                        },
                        {
                            ...
                            pointBackgroundColor: "rgba(100,0,255)",
                            pointBorderColor: "#fff",
                            data: percent_change_24h,
                            lineTension: -0.1
                        },
        ...
        this.dataService.getGlobalData().subscribe(function (res) {
            _this.criptomonedas_activas = res['data'].active_cryptocurrencies;
            _this.mercados_activos = res['data'].active_markets;
            _this.dominacion_bitcoin = res['data'].bitcoin_percentage_of_market_cap;
            _this.market_cap_total = res['data'].quotes.USD.total_market_cap;
            _this.vol24h_total = res['data'].quotes.USD.total_volume_24h;
        });
    };
...
/***/ "./src/app/predicciones/predicciones.component.css":
/*!*********************************************************!*\
  !*** ./src/app/predicciones/predicciones.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "  .card-action{\r\n    display:inline-block; \r\n    width:100%; \r\n    padding:0 2rem;\r\n  }\r\n .tag{\r\n    font-size:16px;  \r\n    background: linear-gradient(to right, rgba(0, 0, 0, 0.2),  rgba(0,0,255,0.5));\r\n    padding:0.3rem;\r\n    min-width:100px; \r\n    border-radius: 0 10px;\r\n    margin: 0.3rem;\r\n  }"

/***/ }),

/***/ "./src/app/predicciones/predicciones.component.html":
/*!**********************************************************!*\
  !*** ./src/app/predicciones/predicciones.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/*!********************************************************!*\
  !*** ./src/app/predicciones/predicciones.component.ts ***!
  \********************************************************/
/*! exports provided: PrediccionesComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrediccionesComponent", function() { return PrediccionesComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var PrediccionesComponent = /** @class */ (function () {
    ...
    PrediccionesComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getPredicciones().subscribe(function (p) {
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_1__(document.getElementById('chart-prediccion-bitcoin'), {
                type: 'bar',
                data: {
                    labels: _this.data.Predicciones[0].Prediccion_RNN.Fechas,
                    datasets: [{
                            label: "Volumen",
                            fill: true,
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_1__(document.getElementById('chart-prediccion-bitcoin-HW'), {
                type: 'bar',
                data: {
                    labels: _this.data.Predicciones[0].Prediccion_HW.Fechas,
                    datasets: [{
                            label: "Volumen",
                            fill: true,
                            backgroundColor: 'rgba(0, 255, 0, 0.2)',
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_1__(document.getElementById('chart-prediccion-bitcoin-ARIMA'), {
                type: 'bar',
                data: {
                    labels: _this.data.Predicciones[0].Prediccion_ARIMA.Fechas,
                    datasets: [{
                            label: "Volumen",
                            fill: true,
                            backgroundColor: 'rgba(0, 255, 0, 0.2)',
    ...
    ], PrediccionesComponent.prototype, "onScroll", null);
    PrediccionesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-predicciones',
            template: __webpack_require__(/*! ./predicciones.component.html */ "./src/app/predicciones/predicciones.component.html"),
            styles: [__webpack_require__(/*! ./predicciones.component.css */ "./src/app/predicciones/predicciones.component.css")]
        }),
        __metadata("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]])
    ], PrediccionesComponent);
    return PrediccionesComponent;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Leandro\Angular\neural-bitcoin\src\main.ts */"./src/main.ts");
